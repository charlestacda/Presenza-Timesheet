    ...
    <div id="wrapper">
      ...
      >
        ...
        <li class="nav-item" id="navEmp">
          <a class="nav-link" onclick="valueSenderTables()">
            <i class="fas fa-fw fa-table"></i>
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <?php
                            // Build the SQL query
							$query = "SELECT t.id, t.name, t.id_emp, t.date, t.timeIn, t.timeOut, t.remarks ,e.department AS department FROM timesheet t JOIN employee e ON t.id_emp = e.id_emp WHERE status ='Active'";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                echo '<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">';
                                    echo '<thead><tr><th>No.</th><th>Name</th><th>Employee ID</th><th>Date</th><th>Time In</th><th>Time Out</th><th>Remarks</th>';
                                        echo '</tr>';
                                    echo '</thead>';
                                    echo '<tbody>';
