                                    ...
                                    <form class="user" method="POST" action="validateLogin.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="name" class="form-control form-control-user"
                                                id="loginUsername" aria-describedby="Name"
                                                placeholder="Username" name="loginUsername">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn mainc btn-user btn-block" style="color: #A1CAE2;" name="login">
                                            Login
                                        </butt>
